...
class MatrixArray {
	...
	public constructor(o: any) {
		if (
			(!Array.isArray(o) && !this._isSupportedType(o)) || // Basic check
		...
		this.buffer = new ArrayBuffer(
			this._rows *
				this._columns *
				(o.BYTES_PER_ELEMENT || BYTES_PER_FLOAT),
		)
	...
	public row(index: number): TMatrixArray {
		return this._array.subarray(
			index * this._columns,
			index * this._columns + this._columns,
		)
	}
	...
	private _isSupportedType(o: any): boolean {
		return (
			Object.prototype.toString.call(o) in
			[
				'[object Float32Array]',
				'[object Float64Array]',
				'[object Int8Array]',
